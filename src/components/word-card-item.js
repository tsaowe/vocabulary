          ...
          <Card
            extra={[
              ...
              <Tag
                key={3}
                onClick={() => {
                  fetch(`https://api.day.app/fBxLdXi5AcZV7QYbTb2vj6/${item.word}/${description}?sound=paymentsuccess&icon=https://avatars.githubusercontent.com/u/1531330?s=96&v=4`).then(()=>{
